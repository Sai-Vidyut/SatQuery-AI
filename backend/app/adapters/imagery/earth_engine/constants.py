...
# Sentinel-2 selection policy (documented):
...
# 4. Select start_anchor scene: minimize |acquisition_date - start_date|,
#    tie-break lower cloud, then lexicographic system:index.
# 5. Select end_anchor scene: minimize |acquisition_date - end_date|,
#    same tie-breaks.
